...
export default function MembersScreen() {
  ...
  return (
    <View className="flex-1 items-center justify-center gap-3 px-6">
      ...
      <Text className="text-center text-lg font-bold text-black">Members</Text>
      <Text className="text-center text-sm text-black/65">View the members of your multisig and their approval status.</Text>
    </View>
  )
